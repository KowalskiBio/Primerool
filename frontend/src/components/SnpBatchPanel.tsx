  ...
  return (
    <div className="bg-gradient-to-br from-green-50 to-emerald-50/30 dark:from-slate-800 dark:to-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-700 mb-6">
      ...
      <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">
        Upload a per-SNP flanking-sequence report (.docx — one 401 bp block per variant, target marked as <code>[REF/ALT]</code>), or paste its plain text. Each block is split into upstream/downstream flanks at the marker and run through WGA/flanking primer design in one batch.
      </p>
